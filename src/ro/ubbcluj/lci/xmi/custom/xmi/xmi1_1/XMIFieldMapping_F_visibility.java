...
public class XMIFieldMapping_F_visibility extends XMLFieldMapping {
   public XMIFieldMapping_F_visibility() {
   }

   public XMIFieldMapping_F_visibility(FieldDescriptor fd) {
      super(fd);
   }
