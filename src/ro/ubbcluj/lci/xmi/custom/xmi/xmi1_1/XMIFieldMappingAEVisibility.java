...
public class XMIFieldMappingAEVisibility extends XMLFieldMapping {
   public XMIFieldMappingAEVisibility() {
   }

   public XMIFieldMappingAEVisibility(FieldDescriptor fd) {
      super(fd);
   }
   ...
   public Object getMappedFieldValue(Object ownerObject) throws IllegalAccessException, InvocationTargetException {
      return new Integer(((AssociationEnd)ownerObject).getVisibility());
   }
