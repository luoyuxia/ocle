...
public class Help extends JFrame {
   ...
   private JToolBar getToolBar() {
      ...
      home = new JButton(new ImageIcon(this.getClass().getResource("/help/images/home.gif")));
      home.setActionCommand("Home");
      home.addActionListener(listener);
      back = new JButton(new ImageIcon(this.getClass().getResource("/help/images/back.gif")));
      back.setActionCommand("Back");
      back.addActionListener(listener);
      back.setEnabled(false);
      front = new JButton(new ImageIcon(this.getClass().getResource("/help/images/forward.gif")));
      front.setActionCommand("Front");
      front.addActionListener(listener);
      front.setEnabled(false);
      find = new JButton(new ImageIcon(this.getClass().getResource("/help/images/find.gif")));
