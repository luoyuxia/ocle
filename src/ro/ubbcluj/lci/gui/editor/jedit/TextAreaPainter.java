...
public class TextAreaPainter extends JComponent implements TabExpander {
   ...
   protected void paintHighlight(Graphics gfx, int line, int y) {
      ...
      int bracketLine_ = this.textArea.getBracketLine();
      int caretLine_ = this.textArea.getCaretLine();
      if (this.bracketHighlight && line == bracketLine_) {
   ...
   protected void paintBracketHighlight(Graphics gfx, int line, int y) {
      int adjust = this.fm.getLeading() + this.fm.getMaxDescent();
      ...
      if (position != -1) {
         ...
         gfx.fillRect(x, y, this.fm.charWidth('(') - 1, this.fm.getHeight() - 1);
      }
   }
