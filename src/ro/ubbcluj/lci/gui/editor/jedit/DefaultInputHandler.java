...
public class DefaultInputHandler extends InputHandler {
   protected AutoIndentFormatter aif;
   ...
   public DefaultInputHandler(AutoIndentFormatter aif) {
      this.aif = aif;
      this.bindings = this.currentBindings = new Hashtable();
      this.addDefaultKeyBindings();
   }
   ...
   public void addDefaultKeyBindings() {
      ...
      this.addKeyBinding("C+a", HOME);
      this.addKeyBinding("END", END);
      this.addKeyBinding("C+E", END);
            ...
            if (o instanceof ActionListener) {
               ...
               if (this.aif != null) {
                  if (keyCode == 10) {
                     ...
                     this.aif.newLineAndIndent(getTextArea(evt), evt);
                  } else if (keyCode == 8) {
                     this.aif.backspaceAndIndent(this, evt, (ActionListener)o);
                  } else {
                     this.executeAction((ActionListener)o, evt.getSource(), (String)null);
                  }
               } else {
   ...
   public void keyTyped(KeyEvent evt) {
      ...
      if (c != '\uffff' && (modifiers & 8) == 0 && c >= ' ' && c != 127) {
         ...
         if (this.aif != null) {
            this.aif.specialWord(getTextArea(evt), evt);
         }
