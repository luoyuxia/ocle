...
public class AFileFilter extends FileFilter implements FilenameFilter {
   ...
   public boolean equals(Object obj) {
      if (!(obj instanceof AFileFilter)) {
         return false;
      } else {
         AFileFilter otherFilter = (AFileFilter)obj;
         return this.description.equals(otherFilter.description) && this.extensions.contains(otherFilter.extensions) && otherFilter.extensions.contains(this.extensions);
      }
   }
}
