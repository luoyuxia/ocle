...
public class SubsystemImpl extends PackageImpl implements Subsystem {
   ...
   public void setInstantiable(boolean isInstantiable) {
      ...
      if (agent != null && agent.firesEvents()) {
         agent.fireChangeEvent(new ChangeEventObject(this, "isInstantiable", 0));
      }
   ...
   public Enumeration getTypedFeatureList() {
   ...
   public Enumeration getInstanceList() {
   ...
   public Enumeration getPowertypeRangeList() {
   ...
   public Enumeration getTypedParameterList() {
   ...
   public Enumeration getCollaborationList() {
   ...
   public Enumeration getObjectFlowStateList() {
   ...
   public Enumeration getClassifierRoleList() {
   ...
   public Enumeration getAssociationList() {
   ...
   public Enumeration getSpecifiedEndList() {
   ...
   public Set allSpecificationElements() {
      Set setallContents = this.allContents();
      Set setSelect = CollectionUtilities.newSet();
      Iterator iter = setallContents.iterator();

      while(iter.hasNext()) {
         ModelElement c = (ModelElement)iter.next();
         ElementOwnership elementOwnershipElementOwnership = c.getNamespace();
         boolean bIsSpecification = elementOwnershipElementOwnership.isSpecification();
         if (bIsSpecification) {
            CollectionUtilities.add(setSelect, c);
         }
      }
   ...
   public Set allOperations() {
      ...
      while(iter.hasNext()) {
         ...
         boolean bOclIsKindOf = Ocl.isKindOf(f, Ocl.getType(new Class[]{Operation.class}));
         if (bOclIsKindOf) {
   ...
   public Set allMethods() {
      ...
      while(iter.hasNext()) {
         Feature f = (Feature)iter.next();
         boolean bOclIsKindOf = Ocl.isKindOf(f, Ocl.getType(new Class[]{Method.class}));
         if (bOclIsKindOf) {
            CollectionUtilities.add(seqSelect, f);
         }
      }
   ...
   public Set allAttributes() {
      ...
      while(iter.hasNext()) {
         Feature f = (Feature)iter.next();
         boolean bOclIsKindOf = Ocl.isKindOf(f, Ocl.getType(new Class[]{Attribute.class}));
         if (bOclIsKindOf) {
            CollectionUtilities.add(seqSelect, f);
         }
      }
   ...
   public Set specification() {
      ...
      while(iter.hasNext()) {
         ...
         boolean bOclIsKindOf = Ocl.isKindOf(d, Ocl.getType(new Class[]{Abstraction.class}));
         ...
         for(Iterator iter1 = setSupplier.iterator(); !bExists0 && iter1.hasNext(); bExists0 = bOclIsKindOf0) {
            ModelElement e = (ModelElement)iter1.next();
            bOclIsKindOf0 = Ocl.isKindOf(e, Ocl.getType(new Class[]{Classifier.class}));
         }
   ...
   protected void internalRemove() {
      Enumeration tmpTypedFeatureEnum = this.getTypedFeatureList();
      ...
      Enumeration tmpInstanceEnum = this.getInstanceList();
      ...
      Enumeration tmpPowertypeRangeEnum = this.getPowertypeRangeList();
      ...
      Enumeration tmpTypedParameterEnum = this.getTypedParameterList();
      ...
      Enumeration tmpCollaborationEnum = this.getCollaborationList();
      ...
      Enumeration tmpObjectFlowStateEnum = this.getObjectFlowStateList();
      ...
      Enumeration tmpFeatureEnum = this.getFeatureList();
      ...
      Enumeration tmpClassifierRoleEnum = this.getClassifierRoleList();
      ...
      Enumeration tmpAssociationEnum = this.getAssociationList();
      ...
      Enumeration tmpSpecifiedEndEnum = this.getSpecifiedEndList();
